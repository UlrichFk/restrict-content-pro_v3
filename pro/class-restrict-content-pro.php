...
/**
 * Change the slug for the plugin dependencies.
 *
 * @since 3.5.46
 *
 ...
 */
function rcp_plugin_dependencies_slug( string $slug ): string {
...
add_filter( 'wp_plugin_dependencies_slug', 'rcp_plugin_dependencies_slug' );
